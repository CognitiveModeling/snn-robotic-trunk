#ifndef __FULLY_CONNECTED_ADAPTIVE_LEAKY_INTEGRATE_AND_FIRE_KERNEL__
#define __FULLY_CONNECTED_ADAPTIVE_LEAKY_INTEGRATE_AND_FIRE_KERNEL__
#include "CudaUtils.h"
/**
...
namespace SNN {
    ...
    namespace Kernels {
        ...
        namespace GPU {
            ...
            /**
             */
            __device__ void fullyConnectedAdaptiveLeakyIntegrateAndFireKernel(
...
#if 0
                    pseudoDerivative[i] = exp(-10.0 * pow((v_ - adaptiveThreshold) / baseThreshold, 2));
#else
#if FloatTypeSize == 32
...
#endif /* __FULLY_CONNECTED_ADAPTIVE_LEAKY_INTEGRATE_AND_FIRE_KERNEL__ */
