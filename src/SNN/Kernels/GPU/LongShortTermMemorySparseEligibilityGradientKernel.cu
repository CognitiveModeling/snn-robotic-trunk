#ifndef __LONG_SHORT_TERM_MEMORY_SPARSE_ELIGIBILITY_GRADIENT_KERNEL__
#define __LONG_SHORT_TERM_MEMORY_SPARSE_ELIGIBILITY_GRADIENT_KERNEL__
#include "CudaUtils.h"
/**
...
namespace SNN {
    ...
    namespace Kernels {
        ...
        namespace GPU {
            ...
            __device__ void longShortTermMemorySparseEligibilityGradientKernel(
                ...
                for (int index = threadIdx.x; index < numStandartSynapses; index += blockDim.x) {
                    ...
                    eligibilityGradients[index] += learnSignals[o] * filteredEligibilityTrace;
...
#endif /* __LONG_SHORT_TERM_MEMORY_SPARSE_ELIGIBILITY_GRADIENT_KERNEL__ */
