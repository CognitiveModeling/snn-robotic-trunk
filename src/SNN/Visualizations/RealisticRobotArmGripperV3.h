#ifndef __REALISTIC_ROBOT_ARM_GRIPPER_V3_H__
#define __REALISTIC_ROBOT_ARM_GRIPPER_V3_H__
            ...
            public:
                ...
                RealisticRobotArmGripperV3(
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        ballJoints[i]->addRotation(i * 120 - 45, 0, 0, 1);
                ...
                void getGripperTip(FloatType &x, FloatType &y, FloatType &z) {
                    ...
                    gripperTransform->Translate(0, 216.85, 0);
...
#endif /* __REALISTIC_ROBOT_ARM_GRIPPER_V3_H__ */
