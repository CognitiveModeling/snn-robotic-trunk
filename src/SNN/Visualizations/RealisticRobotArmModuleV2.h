#ifndef __REALISTIC_ROBOT_ARM_MODULE_V2_H__
#define __REALISTIC_ROBOT_ARM_MODULE_V2_H__
...
namespace SNN {
    ...
    namespace Visualizations {
        ...
        class RealisticRobotArmModuleV2 {
            ...
            friend class RealisticRobotArmGripperV2;
                ...
                RealisticRobotArmModuleV2(
                    ...
                    if (visualized) {
                        ...
                        for (int i = 0; i < 4; i++) {
                            ...
                            linearGears[i]->addRotation(-90, 1, 0, 0);
                            linearGears[i]->addRotation(i * 90, 0, 0, 1);
                            linearGears[i]->transform();
                            ...
                            gears[i]->addRotation(-90, 1, 0, 0);
                            gears[i]->addRotation(i * 90, 0, 0, 1);
                            gears[i]->transform();
...
#endif /* __REALISTIC_ROBOT_ARM_MODULE_V2_H__ */
